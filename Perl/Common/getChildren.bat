...
Usage: getChildren.pl [OPTIONS] [CUI|TERM]
...
This prints out the relation and source information of the children
...
eval(GetOptions( "version", "help", "debug", "username=s", "password=s", "hostname=s", "database=s", "socket=s", "config=s", "file=s", "info")) or die ("Please check the above mentioned option(s).\n");
...
sub minimalUsageNotes {
    ...
    print "Usage: getChildren.pl [OPTIONS] [CUI|TERM]\n";
    &askHelp();
    exit;
}
...
##############################################################################
sub showVersion {
    print '$Id: getChildren.pl,v 1.18 2016/01/07 22:49:33 btmcinnes Exp $';
