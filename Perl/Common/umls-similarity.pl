...
sub loadMeasures {
    print "Starting loadMeasures routine\n";
    my $meas;
...
#  load the UMLS
sub loadUMLS {
	print  "Starting loadUMLS routine:\n";
    if(defined $opt_t) { 
	$option_hash{"t"} = 1;
    }
    if(defined $opt_config) {
	...
	print "Creating UMLS::Interface object...\n";
    $umls = UMLS::Interface->new(\%option_hash); 
	print "UMLS::Interface object created.\n" if $umls;
