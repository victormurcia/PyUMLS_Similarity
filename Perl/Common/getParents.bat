...
This program takes in a cui and returns all of its parents
...
##############################################################################
sub showVersion {
    print '$Id: getParents.pl,v 1.13 2011/08/29 16:37:03 btmcinnes Exp $';
...
##############################################################################
sub askHelp {
    print STDERR "Type getParents.pl --help for help.\n";
}
